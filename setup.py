...
class NPM(Command):
    ...
    targets = [
        os.path.join(here, 'ipytree', 'static', 'extension.js'),
        os.path.join(here, 'ipytree', 'static', 'index.js')
    ]
...
version_ns = {}
with open(os.path.join(here, 'ipytree', '_version.py')) as f:
...
setup_args = {
    ...
    'data_files': [
        ('share/jupyter/nbextensions/ipytree', [
            'ipytree/static/extension.js',
